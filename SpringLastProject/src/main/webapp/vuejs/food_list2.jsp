	...
	<div class="container-fluid">
		<div class="col-sm-8">
			<div class="col-md-3" v-for="vo in list">
		      <div class="thumbnail">
		        <a href="nav-link" @click="detailData(vo.fno)">
				...
				template:`
					<table class="table">
						...
						<tr>
							...
							<th width="50%">{{detail.type}}</th>
						</tr>
						<tr>
							<th width="20%">주소</th>
							<th width="50%">{{detail.address}}</th>
						</tr>
						<tr>
							<th width="20%">전화</th>
							<th width="50%">{{detail.phone}}</th>
						</tr>
						<tr>
							<th width="20%">주차</th>
							<th width="50%">{{detail.parking}}</th>
						</tr>
						<tr>
							<th width="20%">영업 시간</th>
							<th width="50%">{{detail.time}}</th>
						</tr>
						<tr>
							<th width="20%">테마</th>
							<th width="50%">{{detail.theme}}</th>
						</tr>
					</table>
					<table class="table">
						<tr>
