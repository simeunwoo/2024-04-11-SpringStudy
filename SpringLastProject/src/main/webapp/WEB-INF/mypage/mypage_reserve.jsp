...
<body>
	<div id="mypageApp">
		...
		<table class="table" v-if="isShow">
			...
			<tr>
				<td width="30%" class="text-center" rowspan="7">
					<img :src="'http://www.menupan.com'+reserve_info.fvo.poster" style="width:100%">
				</td>
				<td colspan="2">
			...
			<tr>
				<th class="text-center" width="20%">음식 종류</th>
				<td width="50%">{{reserve_info.fvo.type}}</td>
			</tr>
			<tr>
				<th class="text-center" width="20%">영업 시간</th>
		...
		<table class="table" v-if="isShow">
			...
			<tr>
				<td width="20%" class="text-center">예약 번호</td>
			...
			<tr>
				<td width="20%" class="text-center">예약 시간</td>
				<td width="80%">{{reserve_info.rtime}}</td>
			</tr>
			<tr>
				<td width="20%" class="text-center">예약 인원</td>
