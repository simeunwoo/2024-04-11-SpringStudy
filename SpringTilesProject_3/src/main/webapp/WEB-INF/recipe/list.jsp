                ...
                <div class="col-12">
                    <div class="pagination-area d-sm-flex mt-15">
                        <nav aria-label="#">
                            <ul class="pagination">
                            	<c:if test="${startPage>1 }">
	                            	<li class="page-item">
										<a class="page-link" href="../recipe/list.do?page=${startPage-1 }">
										  <i class="fa fa-angle-double-left" aria-hidden="true"></i> Prev</a>
	                                </li>
                                </c:if>
                                <c:forEach var="i" begin="${startPage }" end="${endPage }">
                                	<c:choose>
                                		<c:when test="${i==curpage }"><!-- if -->
                                ...
                                <c:if test="${endPage<totalpage }">
	                                <li class="page-item">
										<a class="page-link" href="../recipe/list.do?page=${endPage+1 }">
                        ...
                        <div class="page-status">
                            <p>전체 ${totalpage } 쪽 중에 ${curpage } 쪽</p>
                        </div>
                    </div>
                </div>
            </div>
