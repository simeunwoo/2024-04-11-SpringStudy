...
<body>
	<div class="row">
		<table class="table">
			...
			<tr>
				<td class="text-center"><img src="../images/re_icon.png"></td>
				<td class="text-center"><img src="../images/re_icon.png"></td>
				<td class="text-center"><img src="../images/re_icon.png"></td>
			</tr>
			<tr>
				...
				<td>
					<c:forEach var="make" items="${mList }" varStatus="s">
						<table class="table">
							<tr>
								<td width="80%">${make }</td>
								<td width="20%"><img src="${iList[s.index] }" style="width:150px;height:80px" class="img-rounded"></td>
							</tr>
						</table>
					</c:forEach>
				</td>
		...
		<table class="table">
			<tr>
				<td width="30%" rowspan="3" class="text-center">
					<img src="${vo.chef_poster }" style="width:150px;height:50px">
				</td>
				<td>${vo.chef }</td>
			</tr>
			<tr>
